...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_SecondSplitter.CreateView(0, 0, RUNTIME_CLASS(CMiniView), CSize(250, 200), pContext);
	m_SecondSplitter.CreateView(1, 0, RUNTIME_CLASS(CMyForm), CSize(250, 400), pContext);
